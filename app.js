var grid = ['item1', 'item2', 'item3', 'item4', 'item5', 'item6', 'item6', 'item7', 'item8', 'item9'];
var arr1 = [];
var arr2 = [];
var arr3 = [];
var arr4 = [];
...
function teamchoice(cliked_id) {
    $('.layer').removeClass('animated');
    $('.layer').fadeOut(400);
    player.team= document.getElementById(cliked_id).innerHTML
    if (player.team === 'X') {
        cpu.team = 'O';
    }
    else{
